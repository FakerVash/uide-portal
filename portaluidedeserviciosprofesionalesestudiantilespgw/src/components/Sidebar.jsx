...
import { Box, List, ListItem, ListItemButton, ListItemIcon, ListItemText, Avatar as MuiAvatar, Chip, Button, Divider, Typography, Drawer, IconButton } from '@mui/material';
...
export const Sidebar = () => {
  ...
  const getNavItems = () => {
    ...
    const clienteItems = [
      { icon: FactCheckIcon, label: 'Mis Anuncios', path: '/mis-requerimientos' },
      { icon: ShoppingBagIcon, label: 'Mis Pedidos', path: '/mis-pedidos' },
    ];
